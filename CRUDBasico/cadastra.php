...
<div>
    <form method="post" enctype="multipart/form-data"> <!-- fomr para indicar q serão enviados dados em binario alem de texto-->
...
<?php
   ...
   //inserindo dados
        define('TAMANHO_MAXIMO', (2 * 1024 * 1024));// definimos o tamanho em mega 2 megas 
    ...
    if ($_SERVER["REQUEST_METHOD"] === 'POST') {
        ...
        try {            
            ...
            if ((trim($ra) == "") || (trim($nome) == "")) {
                ...
                echo "<span id='error'>A imagem deve possuir  no maximo 2MB</span>";
            }
            else {
